...
class AnomalyDetectorLSTM(nn.Module):
    def __init__(self, input_size: int, hidden_size: int, output_size: int,
        ...
        self.linear_output_layer = nn.Linear(in_features=self.hidden_size * self.num_directions,
    ...
    def forward(self, input_data: torch.tensor, device: torch.device) -> torch.tensor:
        ...
        h_0, c_0 = self.initialise_hidden_and_cell_states(batch_size=batch_size,
                                                          device=device)
